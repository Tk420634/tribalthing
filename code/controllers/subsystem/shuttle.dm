...
/datum/controller/subsystem/shuttle/proc/autoEnd() //CIT CHANGE - allows shift to end without being a proper shuttle call?
	if(EMERGENCY_IDLE_OR_RECALLED)
		...
		priority_announce("The SPACE TRAIN will arrive at the SPACE DOCK in [emergency.timeLeft(600)] minutes. Have your tickets ready.", null, "sound/voice/catpeople/distressed.ogg", "[train_company]")
