	...
	switch(mode)
		...
		if(SHUTTLE_CALL)
			if(time_left <= 0)
				...
				priority_announce("The SPACE TRAIN has arrived at the SPACE DOCK. It will depart for SPACE in SPACE [timeLeft(600)] minutes. Have your tickets ready.", null, 'sound/voice/catpeople/distressed.ogg', "[SSshuttle.train_company]")
