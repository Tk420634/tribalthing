...
/datum/outfit/job/tribal/f13hunter
	...
	backpack_contents = list(
		/obj/item/restraints/legcuffs/bola/fragile = 3,
		/obj/item/melee/classic_baton/coyote/oldquarterstaff/disputestick = 1,
		/obj/item/gun/energy/kinetic_accelerator/crossbow/sling = 1,
