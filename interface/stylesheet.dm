...
.velvet					{color: #660015; 	font-weight: bold; animation: velvet;}
.hypnophrase			{color: #3bb5d3;	font-weight: bold;	animation: hypnocolor; animation-direction: alternate;}
.phobia			{color: #dd0000;	font-weight: bold;	animation: phobia;}
